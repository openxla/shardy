// RUN: mpmd_opt %s -mpmd-rule-based-schedule='rules=FragmentScheduleRule(ordered_fragments=[FragmentInfo(origins=["f"],mesh_name="m1",call_counter=0)->FragmentInfo(origins=["g"],mesh_name="m1",call_counter=0)])' -verify-diagnostics | FileCheck %s
