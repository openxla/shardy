...
func.func @assign_of_non_scalar_const()
  -> (!mesh_1_tensor_5_5_ui32, !mesh_2_tensor_5_5_ui32, !mesh_1_tensor_5_5_ui32) attributes {
    "topology"=#mpmd.topology<
      ...
      <"m2": <["y"=2]>>
    >} {
// CHECK-NEXT:  %[[INFERRED_1:.*]] = mpmd.fragment<mesh="m1", origin=[]> () {mpmd.inferred_by = ["infer_mesh_wrap_meshless_ops"]} () {
// CHECK-NEXT:    %[[CONST_1:.*]] = stablehlo.constant dense<1> : tensor<5x5xui32>
// CHECK-NEXT:    mpmd.return %[[CONST_1]]
// CHECK-NEXT:  }
// CHECK-NEXT:  %[[INFERRED_2:.*]] = mpmd.fragment<mesh="m2", origin=[]> () {mpmd.inferred_by = ["infer_mesh_wrap_meshless_ops"]} () {
...
func.func @op_with_no_results(%arg0: tensor<4x16xf32>)
  -> (!mesh_2_tensor_4_16_f32) attributes {
    "topology"=#mpmd.topology<
      ...
      <"m2": <["y"=2]>>
    >} {
// CHECK-NEXT:  %[[INFERRED_1:.*]] = mpmd.fragment<mesh="m2", origin=[]> (%arg0) {mpmd.inferred_by = ["infer_mesh_wrap_meshless_ops"]}
// CHECK-NEXT:    stablehlo.add %arg1, %arg1
// CHECK-NEXT:    mpmd.return
// CHECK-NEXT:  }
// CHECK:       mpmd.fragment<mesh="m2", origin=[]> (%[[INFERRED_1]]) {mpmd.inferred_by = ["infer_mesh_wrap_resultless_ops"]} (%arg1
...
// CHECK-NEXT:  %[[INFERRED_1:.*]] = mpmd.fragment<mesh="m1", origin=[]> (%[[TRANSFER]]) {mpmd.inferred_by = ["infer_mesh_wrap_meshless_ops"]}
// CHECK-NEXT:    stablehlo.add %arg1, %arg1
// CHECK-NEXT:    mpmd.return
// CHECK-NEXT:  }
// CHECK-NEXT:  %[[INFERRED_2:.*]] = mpmd.fragment<mesh="m2", origin=[]> (%arg0) {mpmd.inferred_by = ["infer_mesh_wrap_meshless_ops"]}
// CHECK-NEXT:    stablehlo.add %arg1, %arg1
// CHECK-NEXT:    mpmd.return
// CHECK-NEXT:  }
// CHECK-NEXT:  mpmd.fragment<mesh="m1", origin=[]> (%[[INFERRED_1]]) {mpmd.inferred_by = ["infer_mesh_wrap_resultless_ops"]} (%arg1
// CHECK-NEXT:    sdy.sharding_group %arg1
// CHECK-NEXT:    mpmd.return
// CHECK-NEXT:  }
// CHECK-NEXT:  mpmd.fragment<mesh="m2", origin=[]> (%[[INFERRED_2]]) {mpmd.inferred_by = ["infer_mesh_wrap_resultless_ops"]} (%arg1
// CHECK-NEXT:    sdy.sharding_group %arg1
// CHECK-NEXT:    mpmd.return
// CHECK-NEXT:  }
...
func.func @multiple_meshes_complex(%arg0: tensor<4x8xf32>,
  ...
  -> (tensor<4x16xf32>, tensor<4x8xf32>, tensor<16x8xf32>) attributes {
    "topology"=#mpmd.topology<
      ...
      <"m2": <["y"=2]>>
    >} {
// CHECK-NEXT:  %[[INFERRED_1:.*]] = mpmd.fragment<mesh="m2", origin=[]> (%arg2, %arg4) {mpmd.inferred_by = ["infer_mesh_wrap_meshless_ops"]} (%arg5: tensor<16x8xf32>, %arg6: tensor<16x8xf32>) {
...
// CHECK-NEXT:  %[[INFERRED_2:.*]] = mpmd.fragment<mesh="m1", origin=[]> (%[[FRAGMENT_1]], %arg3) {mpmd.inferred_by = ["infer_mesh_wrap_meshless_ops"]} (%arg5: tensor<4x16xf32>, %arg6: tensor<4x16xf32>) {
