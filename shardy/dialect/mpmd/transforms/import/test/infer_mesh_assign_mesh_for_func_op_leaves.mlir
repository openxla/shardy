...
// CHECK-NEXT:  mpmd.fragment<mesh="m1", origin=[]> (%[[ASSIGN]]) {mpmd.inferred_by = ["infer_mesh_wrap_resultless_ops"]} (%arg1
...
func.func @op_with_no_result_with_src_set(%arg0: tensor<4x8xf32>) -> tensor<4x8xf32>
  ...
  >} {
// CHECK-NEXT:  %[[ASSIGN:.*]] = mpmd.assign %arg0
// CHECK-NEXT:  mpmd.fragment<mesh="m2", origin=[]> (%[[ASSIGN]]) {mpmd.inferred_by = ["infer_mesh_wrap_resultless_ops"]} (%arg1
// CHECK-NEXT:    sdy.sharding_group %arg1
// CHECK-NEXT:    mpmd.return
// CHECK-NEXT:  }
...
// CHECK-NEXT:  mpmd.fragment<mesh="m2", origin=[]> (%[[ASSIGN_2]]) {mpmd.inferred_by = ["infer_mesh_wrap_resultless_ops"]} (%arg1
// CHECK-NEXT:    sdy.sharding_group %arg1
// CHECK-NEXT:    mpmd.return
// CHECK-NEXT:  }
// CHECK-NEXT:  %[[ASSIGN_3:.*]] = mpmd.assign %arg0
// CHECK-NEXT:  mpmd.fragment<mesh="m3", origin=[]> (%[[ASSIGN_3]]) {mpmd.inferred_by = ["infer_mesh_wrap_resultless_ops"]} (%arg1
// CHECK-NEXT:    sdy.sharding_group %arg1
// CHECK-NEXT:    mpmd.return
// CHECK-NEXT:  }
