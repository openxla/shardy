...
func.func @reduce_scatter_duplicate_axes_can_be_merged(%arg0 : tensor<16x8xf32> {sdy.sharding=#sdy.sharding<@mesh, [{"y"}, {}]>}) -> tensor<16x8xf32> {
  // expected-error@+1 {{'sdy.reduce_scatter' op two consecutive sub-axes can be merged: "x":(1)2, "x":(2)2}}
  %0 = sdy.reduce_scatter [{}, {"x":(1)2, "x":(2)2}] %arg0 out_sharding=<@mesh, [{"y"}, {"x"}]> :  tensor<16x8xf32>
  return %0 : tensor<16x8xf32>
}
