...
func.func @all_to_all_with_overlapping_dims(%arg0 : tensor<16x8xf32> {sdy.sharding=#sdy.sharding<@mesh, [{"y"}, {"x"}]>}) -> tensor<16x8xf32> {
  // expected-error @+1 {{overlapping dimensions in all-to-all params: 0}}
