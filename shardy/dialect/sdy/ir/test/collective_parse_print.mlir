...
// TODO(b/410856541): Remove the type name from all-to-all dims.
...
func.func @all_to_all_target_dim_empty_single_param(%arg0 : tensor<16x8xf32> {sdy.sharding=#sdy.sharding<@mesh1, [{"x"}, {}]>}) -> tensor<16x8xf32> {
  // CHECK-NEXT: sdy.all_to_all [ {"x"} : 0 : i64->1 : i64] %arg0 out_sharding=<@mesh1, [{}, {"x"}]>
...
func.func @all_to_all_target_dim_empty_multiple_params(%arg0 : tensor<16x8x4x4xf32> {sdy.sharding=#sdy.sharding<@mesh1, [{"x"}, {"y"}, {}, {}]>}) -> tensor<16x8x4x4xf32> {
  // CHECK-NEXT: sdy.all_to_all [ {"x"} : 0 : i64->2 : i64, {"y"} : 1 : i64->3 : i64] %arg0 out_sharding=<@mesh1, [{}, {}, {"x"}, {"y"}]>
...
func.func @all_to_all_target_dim_not_empty_single_param(%arg0 : tensor<16x8xf32> {sdy.sharding=#sdy.sharding<@mesh1, [{"x"}, {"y"}]>}) -> tensor<16x8xf32> {
  // CHECK-NEXT: sdy.all_to_all [ {"y"} : 1 : i64->0 : i64] %arg0 out_sharding=<@mesh1, [{"x", "y"}, {}]>
...
func.func @all_to_all_target_dim_not_empty_multiple_params(%arg0 : tensor<16x8x4x4xf32> {sdy.sharding=#sdy.sharding<@mesh2, [{"x"}, {"y"}, {"z"}, {}]>}) -> tensor<16x8x4x4xf32> {
  // CHECK-NEXT: sdy.all_to_all [ {"x"} : 0 : i64->1 : i64, {"z"} : 2 : i64->3 : i64] %arg0 out_sharding=<@mesh2, [{}, {"y", "x"}, {}, {"z"}]>
...
func.func @all_to_all_multiple_axes_single_param(%arg0 : tensor<16x8xf32> {sdy.sharding=#sdy.sharding<@mesh2, [{"z", "y", "x"}, {}]>}) -> tensor<16x8xf32> {
  // CHECK-NEXT: sdy.all_to_all [ {"y", "x"} : 0 : i64->1 : i64] %arg0 out_sharding=<@mesh2, [{"z"}, {"y", "x"}]>
...
func.func @all_to_all_multiple_axes_multiple_params(%arg0 : tensor<16x8x4x4xf32> {sdy.sharding=#sdy.sharding<@mesh2, [{"y", "z"}, {}, {"x"}, {}]>}) -> tensor<16x8x4x4xf32> {
  // CHECK-NEXT: sdy.all_to_all [ {"y", "z"} : 0 : i64->1 : i64, {"x"} : 2 : i64->3 : i64] %arg0 out_sharding=<@mesh2, [{}, {"y", "z"}, {}, {"x"}]>
...
func.func @all_to_all_not_all_dims_involved_single_param(%arg0 : tensor<16x8x4x4xf32> {sdy.sharding=#sdy.sharding<@mesh5, [{"x"}, {"y", "z"}, {"w"}, {}]>}) -> tensor<16x8x4x4xf32> {
  // CHECK-NEXT: dy.all_to_all [ {"w"} : 2 : i64->0 : i64] %arg0 out_sharding=<@mesh5, [{"x", "w"}, {"y", "z"}, {}, {}]>
...
func.func @all_to_all_not_all_dims_involved_multiple_params(%arg0 : tensor<16x8x4x4xf32> {sdy.sharding=#sdy.sharding<@mesh5, [{"x"}, {"y", "z"}, {"w"}, {}]>}) -> tensor<16x8x4x4xf32> {
  // CHECK-NEXT: dy.all_to_all [ {"x"} : 0 : i64->2 : i64, {"z"} : 1 : i64->3 : i64] %arg0 out_sharding=<@mesh5, [{}, {"y"}, {"w", "x"}, {"z"}]>
  %0 = sdy.all_to_all [{"x"}: 0->2, {"z"}: 1->3] %arg0 out_sharding=<@mesh5, [{}, {"y"}, {"w", "x"}, {"z"}]> : tensor<16x8x4x4xf32>
  return %0 : tensor<16x8x4x4xf32>
}
...
func.func @all_to_all_subaxis_exact_match_single_param(%arg0 : tensor<16x8xf32> {sdy.sharding=#sdy.sharding<@mesh3, [{"y"}, {"x":(1)2}]>}) -> tensor<16x8xf32> {
  // CHECK-NEXT: sdy.all_to_all [ {"x":(1)2} : 1 : i64->0 : i64] %arg0 out_sharding=<@mesh3, [{"y", "x":(1)2}, {}]>
...
func.func @all_to_all_subaxis_exact_match_multiple_params(%arg0 : tensor<16x8x4x4xf32> {sdy.sharding=#sdy.sharding<@mesh3, [{"y"}, {"x":(1)2}, {}, {}]>}) -> tensor<16x8x4x4xf32> {
  // CHECK-NEXT: sdy.all_to_all [ {"x":(1)2} : 1 : i64->3 : i64, {"y"} : 0 : i64->2 : i64] %arg0 out_sharding=<@mesh3, [{}, {}, {"y"}, {"x":(1)2}]> : tensor<16x8x4x4xf32>
  %0 = sdy.all_to_all [{"x":(1)2}: 1->3, {"y"}: 0->2] %arg0 out_sharding=<@mesh3, [{}, {}, {"y"}, {"x":(1)2}]> : tensor<16x8x4x4xf32>
  return %0 : tensor<16x8x4x4xf32>
}
...
func.func @all_to_all_subaxis_ignored_single_param(%arg0 : tensor<16x8xf32> {sdy.sharding=#sdy.sharding<@mesh3, [{"y"}, {"x":(1)2}]>}) -> tensor<16x8xf32> {
  // CHECK-NEXT: sdy.all_to_all [ {"y"} : 0 : i64->1 : i64] %arg0 out_sharding=<@mesh3, [{}, {"x":(1)2, "y"}]>
...
func.func @all_to_all_subaxis_ignored_multiple_params(%arg0 : tensor<16x8x4x4xf32> {sdy.sharding=#sdy.sharding<@mesh3, [{"y"}, {"x":(1)2}, {}, {}]>}) -> tensor<16x8x4x4xf32> {
  // CHECK-NEXT: sdy.all_to_all [ {"y"} : 0 : i64->2 : i64, {"x":(1)2} : 1 : i64->3 : i64] %arg0 out_sharding=<@mesh3, [{}, {}, {"y"}, {"x":(1)2}]>
...
func.func @all_to_all_subaxis_suffix_of_full_single_param(%arg0 : tensor<16x8xf32> {sdy.sharding=#sdy.sharding<@mesh4, [{"y"}, {"x", "z"}]>}) -> tensor<16x8xf32> {
  // CHECK-NEXT: sdy.all_to_all [ {"x":(4)2, "z"} : 1 : i64->0 : i64] %arg0 out_sharding=<@mesh4, [{"y", "x":(4)2, "z"}, {"x":(1)4}]>
...
func.func @all_to_all_subaxis_suffix_of_full_multiple_params(%arg0 : tensor<16x8x4x4xf32> {sdy.sharding=#sdy.sharding<@mesh4, [{"y"}, {"x", "z"}, {}, {}]>}) -> tensor<16x8x4x4xf32> {
  // CHECK-NEXT: sdy.all_to_all [ {"x":(4)2, "z"} : 1 : i64->3 : i64, {"y"} : 0 : i64->2 : i64] %arg0 out_sharding=<@mesh4, [{}, {"x":(1)4}, {"y"}, {"x":(4)2, "z"}]>
  %0 = sdy.all_to_all [{"x":(4)2, "z"}: 1->3, {"y"}: 0->2] %arg0 out_sharding=<@mesh4, [{}, {"x":(1)4}, {"y"}, {"x":(4)2, "z"}]> : tensor<16x8x4x4xf32>
  return %0 : tensor<16x8x4x4xf32>
}
...
func.func @all_to_all_subaxis_suffix_of_subaxis_single_param(%arg0 : tensor<16x8xf32> {sdy.sharding=#sdy.sharding<@mesh4, [{"y"}, {"z", "x":(1)4}]>}) -> tensor<16x8xf32> {
  // CHECK-NEXT: sdy.all_to_all [ {"x":(2)2} : 1 : i64->0 : i64] %arg0 out_sharding=<@mesh4, [{"y", "x":(2)2}, {"z", "x":(1)2}]>
...
func.func @all_to_all_subaxis_suffix_of_subaxis_multiple_params(%arg0 : tensor<16x8x4x4xf32> {sdy.sharding=#sdy.sharding<@mesh4, [{"y"}, {"z", "x":(1)4}, {}, {}]>}) -> tensor<16x8x4x4xf32> {
  // CHECK-NEXT: sdy.all_to_all [ {"x":(2)2} : 1 : i64->3 : i64, {"y"} : 0 : i64->2 : i64] %arg0 out_sharding=<@mesh4, [{}, {"z", "x":(1)2}, {"y"}, {"x":(2)2}]>
  %0 = sdy.all_to_all [{"x":(2)2}: 1->3, {"y"}: 0->2] %arg0 out_sharding=<@mesh4, [{}, {"z", "x":(1)2}, {"y"}, {"x":(2)2}]> : tensor<16x8x4x4xf32>
  return %0 : tensor<16x8x4x4xf32>
}
