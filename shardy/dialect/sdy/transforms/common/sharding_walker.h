...
// Replaces the sharding of `valueOrFuncResult` with the result of
// `transformFn` with the result of applying `transformFn` on it.
...
// it and the corresponding `ValueOrFuncResult`.
//
