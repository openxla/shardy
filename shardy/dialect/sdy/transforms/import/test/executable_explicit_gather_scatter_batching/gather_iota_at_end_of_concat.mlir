...
// Gather with iota at non-first position in concat.
...
func.func @main() {
  ...
  %col_idx = stablehlo.constant dense<[[3], [0], [5], [2]]> : tensor<4x1xi32>

  %transformed = func.call @transformed_gather(%operand, %col_idx)
      : (tensor<4x8xi32>, tensor<4x1xi32>) -> tensor<4x1xi32>
  %original = func.call @original_gather(%operand, %col_idx)
      : (tensor<4x8xi32>, tensor<4x1xi32>) -> tensor<4x1xi32>
