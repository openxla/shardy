...
#define GEN_PASS_DEF_ADDFUNCDATAFLOWEDGESPASS
...
struct AddFuncDataFlowEdgesPass
    : public impl::AddFuncDataFlowEdgesPassBase<AddFuncDataFlowEdgesPass> {
  using AddFuncDataFlowEdgesPassBase::AddFuncDataFlowEdgesPassBase;
