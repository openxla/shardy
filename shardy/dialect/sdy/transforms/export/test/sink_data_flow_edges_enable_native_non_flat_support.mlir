// RUN: sdy_opt %s -split-input-file -sdy-sink-data-flow-edges='enable-native-non-flat-support=true'  | FileCheck %s
...
func.func @bar(%arg0: tensor<8xf32>) -> tensor<8xf32> {
  ...
  %0 = sdy.data_flow_edge %arg0 : tensor<8xf32>
...
func.func @bar(%arg0: tensor<8xf32>, %arg1: tensor<8xf32>) -> tensor<8xf32> {
  ...
  %0 = sdy.data_flow_edge %arg0 : tensor<8xf32>
  %1 = sdy.data_flow_edge %arg1 : tensor<8xf32>
