...
func.func @replace_smaller_axis_with_bigger_same_dim_non_divisible(%arg0: tensor<16x8xf32> {sdy.sharding = #sdy.sharding<@mesh2d_2x3, [{"x"}, {}]>}) -> tensor<16x8xf32> {
...
func.func @replace_bigger_axis_with_smaller_same_dim_non_divisible(%arg0: tensor<16x8xf32> {sdy.sharding = #sdy.sharding<@mesh2d_2x3, [{"y"}, {}]>}) -> tensor<16x8xf32> {
  ...
  // CHECK-NEXT: return %[[ALL_GATHER]]
 %0 = sdy.reshard %arg0 <@mesh2d_2x3, [{"x"}, {}]> : tensor<16x8xf32>
 return %0 : tensor<16x8xf32>
}

// CHECK-LABEL: func @replace_smaller_axis_with_bigger_gcd_greater_than_one
func.func @replace_smaller_axis_with_bigger_gcd_greater_than_one(%arg0: tensor<16x8xf32> {sdy.sharding = #sdy.sharding<@mesh2d_4x6, [{"x"}, {}]>}) -> tensor<16x8xf32> {
  ...
  // CHECK-NEXT: return %[[ALL_GATHER]]
 %0 = sdy.reshard %arg0 <@mesh2d_4x6, [{"y"}, {}]> : tensor<16x8xf32>
 return %0 : tensor<16x8xf32>
}

// CHECK-LABEL: func @replace_bigger_axis_with_smaller_gcd_greater_than_one
func.func @replace_bigger_axis_with_smaller_gcd_greater_than_one(%arg0: tensor<16x8xf32> {sdy.sharding = #sdy.sharding<@mesh2d_4x6, [{"y"}, {}]>}) -> tensor<16x8xf32> {
  ...
  // CHECK-NEXT: return %[[ALL_GATHER]]
 %0 = sdy.reshard %arg0 <@mesh2d_4x6, [{"x"}, {}]> : tensor<16x8xf32>
 return %0 : tensor<16x8xf32>
}

// CHECK-LABEL: func @swap_non_divisible_axes_diff_dim
func.func @swap_non_divisible_axes_diff_dim(%arg0: tensor<16x8xf32> {sdy.sharding = #sdy.sharding<@mesh2d_2x3, [{"x"}, {"y"}]>}) -> tensor<16x8xf32> {
  ...
  // CHECK-NEXT: return %[[ALL_TO_ALL]]
 %0 = sdy.reshard %arg0 <@mesh2d_2x3, [{"y"}, {"x"}]> : tensor<16x8xf32>
 return %0 : tensor<16x8xf32>
}

// CHECK-LABEL: func @replace_axes_and_all_gather_gcd_greater_than_one
func.func @replace_axes_and_all_gather_gcd_greater_than_one(%arg0: tensor<16x8xf32> {sdy.sharding = #sdy.sharding<@mesh2d_4x6, [{"x"}, {"y":(1)2}]>}) -> tensor<16x8xf32> {
...
func.func @replace_axes_and_all_gather_gcd_greater_than_one_2(%arg0: tensor<16x8xf32> {sdy.sharding = #sdy.sharding<@mesh3d_4x6x2, [{"x"}, {"z"}]>}) -> tensor<16x8xf32> {
  ...
  // CHECK-NEXT: return %[[ALL_GATHER]]
 %0 = sdy.reshard %arg0 <@mesh3d_4x6x2, [{"y"}, {}]> : tensor<16x8xf32>
 return %0 : tensor<16x8xf32>
}

// CHECK-LABEL: func @replace_axes_and_all_gather_gcd_greater_than_one_3
func.func @replace_axes_and_all_gather_gcd_greater_than_one_3(%arg0: tensor<16x8xf32> {sdy.sharding = #sdy.sharding<@mesh3d_4x6x5, [{"x"}, {"z"}]>}) -> tensor<16x8xf32> {
  ...
  // CHECK-NEXT: return %[[ALL_GATHER]]
 %0 = sdy.reshard %arg0 <@mesh3d_4x6x5, [{"y"}, {}]> : tensor<16x8xf32>
 return %0 : tensor<16x8xf32>
}
