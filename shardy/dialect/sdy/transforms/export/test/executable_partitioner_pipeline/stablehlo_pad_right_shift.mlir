...
func.func @parallel_pad_right_shift(
...
func.func @sequential_pad_right_shift(%arg0: tensor<4xi32>, %arg1: tensor<i32>) -> tensor<8xi32> {
...
func.func @main() {
  ...
  %seq = func.call @sequential_pad_right_shift(%input, %c) : (tensor<4xi32>, tensor<i32>) -> tensor<8xi32>
  ...
  %res:2 = "interpreter.run_parallel"(%s0, %s1) {
    programs = [[@parallel_pad_right_shift, @parallel_pad_right_shift]]
