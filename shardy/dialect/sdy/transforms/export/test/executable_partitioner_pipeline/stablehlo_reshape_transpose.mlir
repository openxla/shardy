...
func.func @parallel_reshape_transpose(
  ...
  %1 = sdy.reshard %0 <@mesh, [{}, {}]> : tensor<4x6xi32>
  return %1 : tensor<4x6xi32>
}

func.func @sequential_reshape_transpose(%arg0: tensor<24xi32>) -> tensor<4x6xi32> {
...
func.func @main() {
  ...
  %seq = func.call @sequential_reshape_transpose(%input) : (tensor<24xi32>) -> tensor<4x6xi32>
  ...
  %res:4 = "interpreter.run_parallel"(%s0, %s1, %s2, %s3) {
    programs = [[@parallel_reshape_transpose, @parallel_reshape_transpose, @parallel_reshape_transpose, @parallel_reshape_transpose]]
