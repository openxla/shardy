...
// DO NOT SUBMIT - add test where lhs is unreduced but rhs isn't, and result is unreduced
// DO NOT SUBMIT - add test with manual comp, here and in temp pass!
...
func.func @all_reduce_delayed_until_op(%arg0: tensor<2x64x13xf32> {sdy.sharding = #sdy.sharding<@mesh, [{}, {"x"}, {}]>})
  ...
  // CHECK-NEXT: %[[RESHARD_1:.*]] = sdy.reshard %2 <@mesh, [{}, {"x"}]>
  // CHECK-NEXT: %[[RESHARD_2:.*]] =  sdy.reshard %3 <@mesh, [{}, {"x"}]>
