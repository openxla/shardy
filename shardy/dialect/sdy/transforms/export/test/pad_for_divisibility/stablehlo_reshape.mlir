...
func.func private @reshape_split_indivisible_participating(%arg0: tensor<14xf32>) -> tensor<2x7xf32> {
  %0 = sdy.all_slice [{"x"}] %arg0 out_sharding=<@mesh_4_2, [{"x"}]> : tensor<14xf32>
...
func.func private @reshape_combine_indivisible_participating(%arg0: tensor<2x7xf32>) -> tensor<14xf32> {
