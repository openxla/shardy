...
// CHECK-LABEL: func @src_divisible_tgt_non_divisible(
...
// CHECK-NEXT:  }
func.func @src_divisible_tgt_non_divisible(%arg0: tensor<8x7xf32> {sdy.sharding = #sdy.sharding<@mesh_4, [{"x"}, {}]>}) -> tensor<8x7xf32> {
...
// CHECK-LABEL: func @src_non_divisible_tgt_divisible(
...
// CHECK-NEXT:    return %[[TRIM]] : tensor<8x7xf32>
// CHECK-NEXT:  }
func.func @src_non_divisible_tgt_divisible(%arg0: tensor<8x8xf32> {sdy.sharding = #sdy.sharding<@mesh_4, [{}, {"x"}]>}) -> tensor<8x7xf32> {
...
// CHECK-LABEL: func @both_non_divisible(
...
// CHECK-NEXT:  }
func.func @both_non_divisible(%arg0: tensor<8x8xf32> {sdy.sharding = #sdy.sharding<@mesh_4, [{"x"}, {}]>}) -> tensor<7x7xf32> {
...
// CHECK-LABEL: func @both_divisible(
...
// CHECK-NEXT:  }
func.func @both_divisible(%arg0: tensor<8x8xf32> {sdy.sharding = #sdy.sharding<@mesh_4, [{"x"}, {}]>}) -> tensor<8x8xf32> {
...
// CHECK-LABEL: func @multiple_params(
...
// CHECK-NEXT:  }
func.func @multiple_params(%arg0: tensor<8x8x8x8xf32> {sdy.sharding = #sdy.sharding<@mesh_4_2, [{"x"}, {"y"}, {}, {}]>}) -> tensor<7x7x7x7xf32> {
