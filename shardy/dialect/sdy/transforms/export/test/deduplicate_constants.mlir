// RUN: sdy_opt %s --sdy-deduplicate-constants | FileCheck %s

// CHECK-LABEL: func @dedup_constants_sdy
func.func @dedup_constants_sdy() -> tensor<f32> {
...
// CHECK-LABEL: func @dedup_constants_constant_like
func.func @dedup_constants_constant_like() -> tensor<f32> {
  // CHECK: %[[C0:.*]] = sdy.constant dense<1.0{{.*}}> : tensor<f32>
  // CHECK-NOT: sdy.constant
  %0 = sdy.constant dense<1.000000e+00> : tensor<f32>
  %1 = sdy.constant dense<1.000000e+00> : tensor<f32>
...
// CHECK-LABEL: func @dont_dedup_constants_different_regions
func.func @dont_dedup_constants_different_regions(%arg0: tensor<i32>) -> tensor<i32> {
...
// CHECK-LABEL: func @dont_dedup_constants_different_annotations
func.func @dont_dedup_constants_different_annotations() -> tensor<f32> {
