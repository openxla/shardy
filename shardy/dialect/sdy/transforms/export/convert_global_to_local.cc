...
Value getScatterReductionIdentity(stablehlo::ScatterOp scatter, OpBuilder& b) {
  Operation* reductionOp = getScatterReductionOp(scatter);
  if (!reductionOp) {
    return nullptr;
  }
