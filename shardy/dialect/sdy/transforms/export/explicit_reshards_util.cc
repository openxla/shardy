...
Mesh::Mesh(MeshAttr mesh, StringRef meshName)
    : mesh(mesh), meshName(meshName) {}

MLIRContext* Mesh::getContext() const { return mesh.getContext(); }
MeshAttr Mesh::attr() const { return mesh; }
StringRef Mesh::name() const { return meshName; }
