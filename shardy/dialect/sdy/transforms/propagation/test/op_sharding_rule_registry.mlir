...
func.func @reshape_split_swap_and_merge(%arg0: tensor<4x7x4096x128xf32>) -> tensor<14x8192x128xf32> {
  // CHECK: sdy.sharding_rule = #sdy.op_sharding_rule<([ij, l, n, o])->([ik, mn, o]) {i=2, j=2, k=7, l=7, m=2, n=4096, o=128}>
  %0 = stablehlo.reshape %arg0 : (tensor<4x7x4096x128xf32>) -> tensor<14x8192x128xf32>
  return %0 : tensor<14x8192x128xf32>
}
