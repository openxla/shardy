...
class PipelineSchedule:
  ...
  Attributes:
    ...
    required_mpmd_options: A mapping of PartitioningEnvironment flags that are
      ...
      include:  - mpmd_split_bwd_fragments: Set to True to split backward
        fragments into separate weight gradient and activation gradient
        fragments. This enables independent scheduling of weight and activation
        gradients.  -
