...
#ifndef SHARDY_ROUND_TRIP_IMPORT_REMOVE_SIZE_ONE_AXES_H_
#define SHARDY_ROUND_TRIP_IMPORT_REMOVE_SIZE_ONE_AXES_H_
...
#endif  // SHARDY_ROUND_TRIP_IMPORT_REMOVE_SIZE_ONE_AXES_H_
